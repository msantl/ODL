...
public class Mjerenje2 implements IListenDataPacket {
    ...
    private static final Logger log = LoggerFactory.getLogger(Mjerenje2.class);
    ...
    public PacketResult receiveDataPacket(RawPacket inPkt) {
        ...
        /* TEST SCENARIO
         * 10.0.0.1 TrafficType.VIDEO
         * 10.0.0.2 TrafficType.VOICE
         * 10.0.0.3 TrafficType.DATA
         * 10.0.0.4 TrafficType.OTHER
         *
         * they all send requests to 10.0.0.5 (CDN)
         *
         * 10.0.0.5 responds with the final server, 10.0.0.6
         */

        TrafficType trafficType = null;
        InetAddress streamAddress = null;
        boolean response = false;

        try {
            streamAddress = InetAddress.getByName("10.0.0.6");
        } catch(Exception e) {
            //System.out.println(e.toString());
        }
        ...
        if (!response) {
            ...
            createNewFlow(source, streamAddress, null, trafficType, false);
            long end_time = System.nanoTime();
            System.out.println("Total time elapsed: " + ((end_time - start_time) / 1000.) + " us");
        }
